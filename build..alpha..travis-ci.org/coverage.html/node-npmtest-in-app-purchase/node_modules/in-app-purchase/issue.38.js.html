...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-in-app-purchase/node_modules/in-app-purchase/issue.38.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-in-app-purchase/node_modules/in-app-purchase/issue.38.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-in-app-purchase/node_modules/in-app-purchase/</a> &#187; issue.38.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var iap = require('./');
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		return console.error('setup failed:', error);</span>
	}
	iap.validate(iap.APPLE, receipt, <span class="fstat-no" title="function not covered" >function (error, res) {</span>
<span class="cstat-no" title="statement not covered" >		if (error) {</span>
<span class="cstat-no" title="statement not covered" >			return console.error('validation failed:', error);</span>
		}
&nbsp;
<span class="cstat-no" title="statement not covered" >		console.log('validated:', res);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		if (iap.isValidated(res)) {</span>
<span class="cstat-no" title="statement not covered" >			console.log('OK');</span>
		}
	});
});
&nbsp;
