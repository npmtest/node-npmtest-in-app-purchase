...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-in-app-purchase/node_modules/in-app-purchase/issue.25#2.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-in-app-purchase/node_modules/in-app-purchase/issue.25#2.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-in-app-purchase/node_modules/in-app-purchase/</a> &#187; issue.25#2.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        console.error(err);</span>
    ...
    iap.validate(iap.WINDOWS, windowsReceipt, <span class="fstat-no" title="function not covered" >function (err, windowsRes) {</span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >            console.error(err);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (iap.isValidated(windowsRes)) {</span>
<span class="cstat-no" title="statement not covered" >            console.info("Ok");</span>
        }
    });
});
&nbsp;
